# Weekly Refactoring Analysis — 2026-09-21
...
Found **17** code duplication(s).

| Source A | Source B | Lines | Tokens |
|----------|----------|-------|--------|
| `app/api/admin/freee-credentials/route.ts:3` | `app/api/expense-item/ocr/route.ts:5` | 14 | 54 |
| `app/api/admin/freee-credentials/route.ts:3` | `app/api/expense-item/override/route.ts:2` | 14 | 54 |
...
| `lib/google/drive.ts:37` | `lib/google/drive.ts:70` | 12 | 65 |
